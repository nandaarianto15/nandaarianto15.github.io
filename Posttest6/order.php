...
<body>
    <div class="container">
        <a href="crud/read/read-order.php"><button style="margin-bottom: 5%;">View your order history</button></a>
        <a href="index.php"><img src="assets/img/1.png" width="30%" alt="" class="logo"></a>
        <h1>Laundry Order Form</h1>
        <form id="laundryForm" method="POST" action="crud/create/create-order-function.php" enctype="multipart/form-data">
