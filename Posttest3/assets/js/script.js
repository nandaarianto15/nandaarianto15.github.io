...
document.addEventListener("DOMContentLoaded", function() {
    // Pilih tombol "Order Now" pada header
    const orderButton = document.querySelector(".header-content .order-btn");
    if (orderButton) {
    ...
    // Pilih tombol "Send Message" pada form contact
    const sendMessageButton = document.querySelector(".contact .btn-contact");
